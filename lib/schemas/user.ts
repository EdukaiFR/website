...
export const subscriptionPlans = {
  free: {
    label: 'Gratuit',
    price: '0€/mois',
    features: ['5 questions par jour', 'Matières de base', 'Support communautaire']
  },
  premium: {
    label: 'Premium',
    price: '9,99€/mois',
    features: ['Questions illimitées', 'Toutes matières', 'Support prioritaire', 'Statistiques avancées']
  },
  student: {
    label: 'Étudiant',
    price: '4,99€/mois',
    features: ['Questions illimitées', 'Toutes matières', 'Support étudiant', 'Tarif préférentiel']
  }
} as const;
...
export const customEducationRequestSchema = z.object({
  ...
  educationLevel: z.enum(['college', 'lycee', 'superieur']),
  requestedValue: z.string().min(2, 'La demande doit contenir au moins 2 caractères'),
...
export type EducationSettingsFormValues = z.infer<typeof educationSettingsSchema>;
export type SubscriptionSettingsFormValues = z.infer<typeof subscriptionSettingsSchema>;
export type PreferencesSettingsFormValues = z.infer<typeof preferencesSettingsSchema>;
export type CustomEducationRequestFormValues = z.infer<typeof customEducationRequestSchema>;
