...
export const siteConfig = {
    ...
    description:
        "Plateforme d'apprentissage intelligente qui génère automatiquement des quiz et fiches de révision à partir de vos cours. Optimisez votre temps de révision avec l'IA.",
