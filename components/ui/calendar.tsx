  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-primary text-primary-foreground hover:bg-primary hover:bg-opacity-25 hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground",
        day_today: "bg-accent bg-opacity-25 text-accent-foreground",
        day_outside:
          "day-outside text-muted-foreground aria-selected:bg-primary/50 aria-selected:text-muted-foreground",
        day_disabled: "text-muted-foreground opacity-50",
        day_range_middle:
          "aria-selected:bg-primary bg-opacity-50 aria-selected:text-accent-foreground",
