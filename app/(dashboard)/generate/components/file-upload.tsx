        ...
        <div className="mt-6 space-y-3">
          <div className="flex items-center justify-between">
            ...
            {isRecognizing && (
              <div className="text-sm text-blue-600 font-medium">
                ...
                {currentlyProcessingCount > 1 ? "s" : ""} en cours...
              </div>
            )}
          </div>
          {selectedFiles.map((file, index) => {
            ...
            const shouldQueue =
              !hasBeenProcessed &&
              !isProcessing &&
              currentlyProcessingCount >= MAX_CONCURRENT_PROCESSING;
                      ...
                      {hasBeenProcessed ? (
                        ...
                        <TextRecognizer
                          ...
                          onTextRecognized={(text) =>
                            onRecognizedText(text, fileId)
                          }
                          setIsRecognizing={(processing) =>
                            setFileProcessing(fileId, processing)
                          }
                        />
                      )}
                    </div>
