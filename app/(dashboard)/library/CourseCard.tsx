        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex items-center justify-between pt-3 border-t border-gray-100 group-hover:border-gray-200 transition-colors">
            <div className="flex items-center gap-2">
              <div className={`w-2 h-2 rounded-full transition-all ${isPublished ? 'bg-green-500 group-hover:shadow-green-200 group-hover:shadow-lg' : 'bg-yellow-500 group-hover:shadow-yellow-200 group-hover:shadow-lg'}`} />
