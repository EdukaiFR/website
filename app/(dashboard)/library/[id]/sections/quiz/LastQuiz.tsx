...
export const LastQuiz = ({
  ...
  const calculateInsights = () => {
    ...
    if (insights.length >= 6) {
      const recent = insights.slice(-3).reduce((a, b) => a + b.score, 0) / 3;
      const previous =
    ...
    const recentScores = insights.length >= 5 ? insights.slice(-5) : insights;
    const recentAverage =
  ...
  const getMotivationalMessage = () => {
    ...
    if (trend === "up") {
      return {
        ...
        message: "Tes scores s'améliorent régulièrement. Continue comme ça !",
        type: "improving",
      };
    }
    ...
    if (avgScore >= 60) {
      return {
        title: "💪 Bon travail !",
        message: "Tu progresses bien. Quelques révisions et tu seras au top !",
        type: "good",
      };
    }
    ...
    return {
      ...
      message: "Chaque quiz est une opportunité d'apprendre. Tu y arrives !",
      type: "encouraging",
    };
  };
