    ...
    <div className="flex flex-col w-full gap-4">
      ...
      <div className="flex flex-col gap-2">
        {answers.map((answer, index) => {
          ...
          let buttonStyles = "border border-gray-200 bg-white/80 text-gray-700 hover:bg-blue-50 hover:border-blue-300";
          let iconElement = null;

          if (isSelected && !isAnswer) {
            buttonStyles = "border-blue-600 bg-blue-50 text-blue-700";
          } else if (isAnswer) {
            if (isCorrectAnswer) {
              ...
              buttonStyles = "border-gray-200 bg-gray-50 text-gray-500";
            }
          }
      ...
      {isAnswer && explanation && (
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-3 mt-3">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-semibold text-blue-800 mb-1 text-sm">Explication</h4>
