          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            ...
            <div className="flex-1 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-sm font-medium">Communauté Étudiante</span>
              </div>
              ...
              <p className="text-xl lg:text-2xl text-blue-100 mb-8 max-w-2xl">
                Rejoignez une communauté passionnée d'apprenants et développez vos compétences ensemble dans un environnement collaboratif et bienveillant.
              </p>
            ...
            <div className="flex-1 max-w-md">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/30 transition-all duration-300 hover:bg-white/30 hover:backdrop-blur-md hover:shadow-2xl hover:shadow-white/20 hover:scale-105 hover:border-white/50 cursor-pointer group">
                  ...
                  <div className="text-3xl font-bold mb-1 transition-all duration-300 group-hover:scale-110">2,500+</div>
                  <div className="text-blue-100 text-sm transition-all duration-300 group-hover:text-white">Membres Actifs</div>
                </div>
                ...
                <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/30 transition-all duration-300 hover:bg-white/30 hover:backdrop-blur-md hover:shadow-2xl hover:shadow-white/20 hover:scale-105 hover:border-white/50 cursor-pointer group">
                  ...
                  <div className="text-3xl font-bold mb-1 transition-all duration-300 group-hover:scale-110">150+</div>
                  <div className="text-blue-100 text-sm transition-all duration-300 group-hover:text-white">Événements</div>
                </div>
                ...
                <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/30 transition-all duration-300 hover:bg-white/30 hover:backdrop-blur-md hover:shadow-2xl hover:shadow-white/20 hover:scale-105 hover:border-white/50 cursor-pointer group">
                  ...
                  <div className="text-3xl font-bold mb-1 transition-all duration-300 group-hover:scale-110">50+</div>
                  <div className="text-blue-100 text-sm transition-all duration-300 group-hover:text-white">Récompenses</div>
                </div>
                ...
                <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/30 transition-all duration-300 hover:bg-white/30 hover:backdrop-blur-md hover:shadow-2xl hover:shadow-white/20 hover:scale-105 hover:border-white/50 cursor-pointer group">
                  ...
                  <div className="text-3xl font-bold mb-1 transition-all duration-300 group-hover:scale-110">4.9</div>
                  <div className="text-blue-100 text-sm transition-all duration-300 group-hover:text-white">Note Moyenne</div>
                </div>
              </div>
            </div>
          </div>
