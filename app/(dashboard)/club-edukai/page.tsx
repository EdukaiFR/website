          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-base lg:text-lg text-blue-100 mb-8 max-w-2xl">
                Rejoignez une communauté passionnée d'apprenants et développez
                vos compétences ensemble dans un environnement collaboratif et
                bienveillant.
              </p>
        ...
        <div className="container mx-auto px-6 py-12">
          ...
          <div className="text-center py-20">
            ...
            <p className="text-gray-600 mt-4 max-w-md mx-auto">
              Cette section sera bientôt remplie avec du contenu passionnant sur
              le Club Edukai.
            </p>
          </div>
        </div>
