      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <Button
                ...
                variant={selectedForm === 'signin' ? 'default' : 'outline'}
                className="w-full"
              >
                Signin Form
              </Button>
              <Button
                ...
                variant={selectedForm === 'signup' ? 'default' : 'outline'}
                className="w-full"
              >
                Signup Form
              </Button>
              <Button
                ...
                variant={selectedForm === 'reset' ? 'default' : 'outline'}
                className="w-full"
              >
                Reset Password Form
              </Button>
              <Button
                ...
                variant={selectedForm === 'change' ? 'default' : 'outline'}
                className="w-full"
              >
          ...
          <Card>
            <CardHeader>
              <CardTitle>
                {selectedForm ? `${selectedForm.charAt(0).toUpperCase() + selectedForm.slice(1)} Form` : 'Select a Form'}
              </CardTitle>
            </CardHeader>
            <CardContent>
              {selectedForm ? (
                ...
                <div className="text-center py-12 text-gray-500">
                  Choose a form from the left to see it in action
                </div>
              )}
            </CardContent>
          </Card>
        ...
        <Card className="mt-8">
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-semibold text-gray-900 mb-2">Signin</h4>
